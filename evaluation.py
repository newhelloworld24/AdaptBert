...
def model_eval_sst_single_task(sentiment_dataloader, model, device):
    model.eval()  # Switch to eval model, will turn off randomness like dropout.
...
def model_eval_para_single_task(paraphrase_dataloader, model, device):
    model.eval()  # Switch to eval model, will turn off randomness like dropout.
...
def model_eval_sts_single_task(sts_dataloader, model, device):
    model.eval()  # Switch to eval model, will turn off randomness like dropout.
